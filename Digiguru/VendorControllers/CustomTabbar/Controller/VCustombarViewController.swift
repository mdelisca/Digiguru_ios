//
//  VCustombarViewController.swift
//  Digiguru
//
...
class VCustombarViewController: UITabBarController {
...
//        myTabBar.roundCorners([.topLeft,.topRight], radius: 25)
    ...
    func setTabBarItems(){
       // myTabBar.layer.masksToBounds = false
        ...
        myTabBarItem2.image = UIImage(named: "Upload Routines")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        myTabBarItem2.selectedImage = UIImage(named: "Upload Routines1")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        myTabBarItem2.title = ""

        
        
        let myTabBarItem3 = (self.myTabBar.items?[2])! as UITabBarItem
        myTabBarItem3.image = UIImage(named: "More")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        myTabBarItem3.selectedImage = UIImage(named: "More1")?.withRenderingMode(UIImage.RenderingMode.alwaysOriginal)
        myTabBarItem3.title = ""
