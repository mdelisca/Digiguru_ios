...
class UBuyNowViewController: UIViewController {
...
extension UBuyNowViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    @objc func GotoNext(sender: UIButton){
        ...
        let vcc: PaymentCardViewController = storyboard.instantiateViewController(withIdentifier: "PaymentCardViewController") as! PaymentCardViewController
